...
ControlClick($win, "", $PROGRAM_BUTTON_ID)
...
While 1
  ...
  If ControlCommand($win, "", $PROGRAM_BUTTON_ID, "IsEnabled", "") Then
    Sleep(500)
    If ControlCommand($win, "", $PROGRAM_BUTTON_ID, "IsEnabled", "") Then ExitLoop
  EndIf

  ExitIf(TimerDiff($timer) > $timeout, "PROGRAMMING_TIMEOUT")
